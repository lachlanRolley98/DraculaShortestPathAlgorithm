...
typedef enum weightings{ // all weightings should be less than or equal to 40 (points can become -ve) 
    ...
    LOCATION_IS_CASTLE_DRACULA = 15,// 15 points lost (ideally dracula doesn't want to go to CD) 
    ...
    LOCATION_IS_REACHABLE_BY_HUNTER = 34, // If a location is directly reachable by a hunter location loses 34 points
} Weightings;
