...
int main(void)
{
	...
	{///////////////////////////////////////////////////////////////////
		...
		assert(GvGetPlayerLocation(gv, PLAYER_DRACULA) == TELEPORT);
		assert(GvGetVampireLocation(gv) == NOWHERE);
	...
	{///////////////////////////////////////////////////////////////////
		...
		{
			printf("\tChecking reachable locations for Vienna with "
					"Lord Godalming using GvGetReachable (Round 0)\n");         
			int numLocs = -1;
		...
		{
			printf("\tChecking reachable locations for Vienna with "
					"Lord Godalming using GvGetReachable (Round 1)\n");         
			int numLocs = -1;
			PlaceId *locs = GvGetReachable(gv, PLAYER_LORD_GODALMING,
			                                     1, VIENNA, &numLocs);
			// printf("\n%d\n", numLocs);
		...
		{
			printf("\tChecking reachable locations for Vienna with "
					"Lord Godalming using GvGetReachable (Round 2)\n");
			int numLocs = -1;
			PlaceId *locs = GvGetReachable(gv, PLAYER_LORD_GODALMING,
			                                     2, VIENNA, &numLocs);
		...
		{
			printf("\tChecking reachable locations for Vienna with "
					"Lord Godalming using GvGetReachable (Round 3)\n");
			int numLocs = -1;
			PlaceId *locs = GvGetReachable(gv, PLAYER_LORD_GODALMING,
			                                     3, VIENNA, &numLocs);
		...
		{
			printf("\tChecking reachable locations for Marseilles with "
					"Dracula using GvGetReachable\n");
			int numLocs = -1;
			PlaceId *locs = GvGetReachable(gv, PLAYER_DRACULA,
			                                     1, MARSEILLES, &numLocs);
			...
			assert(locs[4] == MEDITERRANEAN_SEA);
			assert(locs[5] == MILAN);
		...
		{
			printf("\tAsserting that Dracula will not go to a Hospital\n");
			int numLocs = -1;
			PlaceId *locs = GvGetReachable(gv, PLAYER_DRACULA,
			                                     69, SARAJEVO, &numLocs);
