 ...
 * !NOTE: The arguments of the function is how the game engine interacts with the gameview. 
 * !Gameview then 'distributes' the information via function calls from hunterview and dracula view
 */
...
/**
 * Gets the current health points for the given player; a value between
